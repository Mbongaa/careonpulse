...
function ToolGroupTrigger({
  ...
  const label = count === 1 ? "1 tool-aanroep" : `${count} tool-aanroepen`;

  return (
    <CollapsibleTrigger
      data-slot="tool-group-trigger"
      className={cn(
        "group/trigger flex items-center gap-2 text-sm transition-colors",
    ...
    >
      ...
      <span
        className={cn(
          "relative inline-block text-start font-medium leading-none",
