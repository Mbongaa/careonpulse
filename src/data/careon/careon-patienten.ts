...
export const PATIENTEN_METRICS: CareonMetric[] = [
  { label: "Actieve patiënten", value: 1248, prev: 1215, f: "int", detailId: "actief" },
  { label: "Nieuwe patiënten", value: 86, prev: 79, f: "int", detailId: "aanmeldingen" },
  { label: "Uitstroom", value: 74, prev: 82, f: "int", neutralDown: true, detailId: "gesloten" },
  { label: "Wachtlijst intake", value: 43, prev: 51, f: "int", betterLow: true, detailId: "wachtlijst-intake" },
  {
    ...
    f: "int",
    betterLow: true,
    detailId: "wachtlijst-behandeling",
  },
  { label: "Zonder behandelaar", value: 9, prev: 14, f: "int", betterLow: true, detailId: "zonder-behandelaar" },
  { label: "Zonder vervolgafspraak", value: 31, prev: 42, f: "int", betterLow: true, detailId: "zondervervolg" },
  { label: ">30 dgn geen contact", value: 58, prev: 66, f: "int", betterLow: true, detailId: "contact30" },
  { label: ">60 dgn geen contact", value: 23, prev: 28, f: "int", betterLow: true, detailId: "contact60" },
  { label: "Crisiscliënten", value: 7, prev: 5, f: "int", betterLow: true, detailId: "crisis" },
];
