...
import {
  CareonAlertsNavBadge,
  CareonSourceNavBadge,
} from "@/app/(main)/dashboard/_components/careon/careon-nav-badges";
...
function NavItemBadge({ badge }: { badge?: NavBadge }) {
  ...
  if (badge === "alerts") {
    return <CareonAlertsNavBadge />;
  }

  if (badge === "source") {
    return <CareonSourceNavBadge />;
  }
