      ...
      <main className="flex flex-1 items-center justify-center p-5 pb-16 md:p-8">
        <div className="w-full max-w-2xl space-y-8">
          <div className="space-y-2 text-center">
            <p className="text-[10px] text-muted-foreground uppercase tracking-[0.36em]">{CAREON_ORG.name}</p>
            <h1 className="font-semibold text-3xl tracking-tight">Kies een module</h1>
            <p className="mx-auto max-w-md text-muted-foreground">
              U bent ingelogd bij {CAREON_ORG.name}. Open een module om verder te gaan.
            </p>
          </div>
