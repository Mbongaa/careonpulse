...
- **Soft-404-kanttekening**: onbekende detail-ids renderen de Nederlandse 404-pagina maar met HTTP 200 — de dashboard-layout leest `cookies()` en streamt, dus de status is al verstuurd vóór `notFound()`. Ongematchte routes buiten het segment geven onveranderd een echte 404 (bestaande gate).
